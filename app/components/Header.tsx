    ...
    <>
      <nav className="fixed top-0 left-0 right-0 z-[60] bg-[#1B2B4E]/95 backdrop-blur-sm border-b border-[#2A3E60]">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <a href="#" className="bg-white px-3 py-1 rounded">
            <Image src="/logo-transparent.png" alt="佳阳移民 JiaYang Immigration" width={160} height={40} className="h-9 w-auto object-contain" />
          </a>
