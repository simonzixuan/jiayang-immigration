...
const t = {
  zh: {
    ...
    faqs: [
      ...
      { q: "Richmond 哪里可以做加拿大移民咨询？", a: "佳阳移民位于 Richmond BC，服务列治文、大温哥华及境内外客户。您可以通过电话、微信、邮件联系，也可以预约到办公室咨询加拿大移民申请方向。" },
  ...
  en: {
    ...
    faqs: [
      ...
      { q: "Where can I get Chinese immigration services in Richmond BC?", a: "JiaYang Immigration is based in Richmond BC and serves clients across Richmond, Greater Vancouver, and overseas. Consultations are available by phone, WeChat, email, or appointment at our office." },
