...
const t = {
  zh: {
    ...
    services: [
      ...
      { num: "07", title: "美国签证", desc: "协助申请美国旅游、探亲及商务签证，专业准备材料，提高获签率。" },
      { num: "08", title: "澳大利亚签证", desc: "澳大利亚旅游、学习及探亲签证申请，助您顺利踏上澳洲之旅。" },
      { num: "09", title: "加拿大签证", desc: "为境外人士申请加拿大旅游、探亲及过境签证，专业高效，安心来加。" },
    ],
    aboutTag: "关于我们",
    aboutTitle: "佳阳移民",
  ...
  en: {
    ...
    services: [
      ...
      { num: "07", title: "US Visa", desc: "Tourist, family, and business visa applications for the United States, with professional document preparation to maximize approval rates." },
      { num: "08", title: "Australia Visa", desc: "Australian tourist, student, and family visit visa applications to help you make the journey to Australia." },
      { num: "09", title: "Canada Visa", desc: "Canadian visitor, family visit, and transit visa applications for those outside Canada — professional and efficient." },
    ],
    aboutTag: "About Us",
